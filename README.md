...
| **Triangulation Final Result** | `@ALL TRIANGULATION_FINAL:lat,lon,confidence,uncertainty,coordinatorId` | `@ALL TRIANGULATION_FINAL:40.712800,-74.006000,85.5,12.3,NODE_ABC` |
