...
| **Triangulation Final Result** | `@ALL TRIANGULATION_FINAL: MAC=mac GPS=lat,lon CONF=conf UNC=unc COORD=nodeId` | `@ALL TRIANGULATION_FINAL: MAC=AA:BB:CC:DD:EE:FF GPS=40.712800,-74.006000 CONF=85.5 UNC=12.3 COORD=AH903` |
