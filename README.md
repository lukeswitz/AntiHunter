...
4. **Configure the Meshtastic radio.** Soldered Core and Assembled tiers ship configured - set the region, pin and channel and skip to step 5. Otherwise plug the radio in on its own USB and run:
