...
- rbcm. for the v1.0.2 field report behind the internal-RAM fix — long BLE device scans aborting in `fopen`, with the device count and the conditions that reproduced it.
