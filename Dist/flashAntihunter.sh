...
FIRMWARE_OPTIONS=(
    "AntiHunter AP (With WiFi AP) - v0.9.5 :https://github.com/lukeswitz/AntiHunter/raw/refs/heads/main/Dist/antihunter-full-v0.9.5.bin"
    "AntiHunter Headless - (Mesh only) v0.9.5:https://github.com/lukeswitz/AntiHunter/raw/refs/heads/main/Dist/antihunter-headless-v0.9.5.bin"
)
ESPTOOL_DIR="esptool"
CUSTOM_BIN=""
CONFIG_MODE=false
